...
const step1 = `
1. Each day we'll text you a link to a prompt, which you'll respond to in
your chosen language with the audio recorder component on the page.
Speak for as long as you have things to say. The more the better!
`

const step2 = `
2. Within 24 hours we'll send you a new link with audio and text
corrections made by an experienced teacher in your chosen language.
`
